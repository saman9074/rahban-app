...
// Imports for Background Service & Offline Storage
import 'package:hive_flutter/hive_flutter.dart';
import 'package:rahban/models/offline_packet.dart';
import 'package:rahban/services/background_service.dart';
...
void main() async {
  ...
  // Initialize native-only features (Camera, Hive, Background Service)
  if (!kIsWeb) {
    try {
    ...
    // Initialize Hive and Background Service
